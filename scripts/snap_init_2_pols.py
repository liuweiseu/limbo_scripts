...
#fpg_file = 'limbo_500_v1_2_2023-04-11_1340.fpg'
fpg_file = 'limbo_500_v1_2_2023-04-11_1634.fpg'
...
snap.registers['sel2'].write_int(data_sel)
# set coeff, which is the coefficient for the 64-bit spectra data
snap.registers['coeff1'].write_int(spec_coeff)
snap.registers['coeff2'].write_int(spec_coeff)

snap.registers['pwr_gain0'].write_int(1)
snap.registers['pwr_gain1'].write_int(1)
snap.registers['pwr_gain2'].write_int(1)
snap.registers['pwr_gain3'].write_int(1)
coeff = 2**12-1
...
d=snap.registers['pwr_gain0'].read_uint()
print(d)
d=snap.registers['pwr_gain1'].read_uint()
print(d)
d=snap.registers['pwr_gain2'].read_uint()
print(d)
d=snap.registers['pwr_gain3'].read_uint()
print(d)
